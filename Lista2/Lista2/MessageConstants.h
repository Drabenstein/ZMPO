...
namespace MessageConstants
{
	...
	extern const std::string MSG_INPUT_TABLE_NAME;
	extern const std::string MSG_INPUT_TABLE_LENGTH;
	extern const std::string MSG_INPUT_VALUE;

	extern const std::string MSG_DEFAULT_TABLE_CREATED;
	extern const std::string MSG_TABLE_PARAMETERED_CREATED;
